...
parser.add('--crit-dict', '-d', help='dictionary of logged measures: abbrev:loggged_key,agg_func;...',default='tr:train_loss,min;ts:valid_loss,min;tr_f:final_train_loss,min;tr_ef:final_epoch_loss,min;w:bp_wt,mean;ts_iou:valid_iou,max;tr_iou:train_iou,max;tr_e:epoch_train_loss,min;lr:lr,mean')
